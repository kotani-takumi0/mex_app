...
開発**過程**を自動記録し、使用技術の**理解度**を検証する新しいポートフォリオプラットフォーム。

1. **MCPサーバー**によりAI開発の過程を自動記録（入力の手間を大幅削減）
2. 使用技術の**理解度チェック問題**を自動生成し回答させる
3. 「完成物 + 過程 + 理解度」を企業に見せる**新しいポートフォリオ**
...
2. **理解度チェック** — 使用した技術の理解度を4択クイズで確認。苦手分野も可視化。
3. **新しいポートフォリオ** — 完成物だけでなく「過程 + 理解度」を企業に見せられる。
